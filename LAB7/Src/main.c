...
osThreadId readSensorsDataHandle;
osThreadId AutoTransitionHandle;
/* USER CODE BEGIN PV */
...
/* USER CODE BEGIN Header_StartChangeMode */
/**
...
/* USER CODE BEGIN Header_StartReadSensorsData */
/**
* @brief Function implementing the readSensorsData thread.
* @param argument: Not used
* @retval None
*/
...
void StartReadSensorsData(void const * argument)
{
  ...
  /* USER CODE END StartReadSensorsData */
}

/* USER CODE BEGIN Header_StartAutoTransition */
/**
* @brief Function implementing the AutoTransition thread.
* @param argument: Not used
* @retval None
*/
...
void StartAutoTransition(void const * argument)
{
  ...
  /* USER CODE END StartAutoTransition */
}
